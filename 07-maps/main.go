...
func main() {
	...
	fmt.Printf("The value for key %q is %q \n", "Rian", employees["Rian"]) // => The value for key "Rian" is ""
	...
	// employees["Rian"] = "Programmer" // error -> panic: assignment to entry in nil map
	...
	friends := map[string]int{"Rian": 40, "Maria": 35}
	...
	fmt.Println(neighbors) // -> map[Rian:30 Maria:35]
